**Tech Lead** at [DNA Script](https://www.dnascript.com), building the software that runs a benchtop DNA synthesizer — instrument control in C++, a TypeScript cloud backend, and a Rust desktop app driving the lab automation hardware alongside it. Joined DNA Script in January 2021 on the legacy Console web app, then moved to build the Syntax synthesizer's operator UI from an empty repo — now own the architecture across instrument, cloud, and the systems connecting them.
